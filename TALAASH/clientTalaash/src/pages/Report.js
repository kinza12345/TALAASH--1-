...
class Report extends Component {
  ...
  printDocument() {
    ...
    html2canvas(input).then((canvas) => {
      ...
      // pdf.text(75, 25, data);
      pdf.text(55, 180, "Name: Ali");
      pdf.text(55, 190, "Age: 20");
      pdf.text(55, 200, "Time 12/12");
      pdf.text(55, 210, "Address: HouseNoM66 Rawalpindi");
      pdf.text(55, 220, "Phone: 03315046985");
      pdf.text(55, 230, "Gender: Male");
      pdf.text(55, 240, "Wearing: Blueshirt");
